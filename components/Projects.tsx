  ...
  return (
    <section id="projects" className="section-gradient-a py-20 px-4">
      <div className="max-w-5xl mx-auto">
        ...
        >
          <span className="text-indigo-400 font-mono text-base mr-2">03.</span>
          Projects
        </motion.h2>
        ...
        <div className="grid sm:grid-cols-2 gap-6">
          {PROJECTS.map((project, i) => (
            <motion.article
              ...
              className="group relative rounded-xl border border-white/8 card-gradient p-6 transition-all duration-300 hover:border-indigo-500/30 hover:shadow-[0_8px_32px_-8px_rgba(99,102,241,0.15)]"
            >
              {/* Top glow on hover */}
              <div className="pointer-events-none absolute inset-x-0 -top-px h-px bg-linear-to-r from-transparent via-indigo-500/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
              ...
              <div className="flex items-start justify-between gap-2 mb-3">
                ...
                <motion.a
                  ...
                  className="p-2 rounded-lg text-zinc-600 hover:text-white hover:bg-white/10 transition-colors shrink-0"
              ...
              <div className="flex flex-wrap gap-2">
                {project.tech.map((t, j) => (
                  <span
                    key={t}
                    className="px-2.5 py-1 rounded-md bg-white/4 border border-white/8 text-zinc-500 text-xs font-mono transition-all duration-200 group-hover:border-indigo-500/20 group-hover:text-zinc-400"
                    style={{
              ...
              <div className="mt-4 flex items-center gap-1.5 text-xs text-indigo-400/0 group-hover:text-indigo-400/70 transition-all duration-300 translate-y-1 group-hover:translate-y-0">
