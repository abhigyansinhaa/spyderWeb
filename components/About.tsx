  ...
  return (
    <section id="about" className="section-gradient-b py-20 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        >
          <div>
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 heading-accent">
              <span className="text-indigo-400 font-mono text-base mr-2">01.</span>
              About Me
            </h2>
          ...
          >
            ...
            <p className="text-zinc-500 text-sm mt-1">Bhubaneswar, India</p>
            <p className="text-indigo-400 font-mono text-sm mt-2 font-medium">
              B.Tech in Computer Science
            </p>
            <p className="text-zinc-600 text-sm mt-1">CGPA: 9.1 · July 2023 – Present</p>
          </motion.div>
        </motion.div>
        ...
        >
          <div className="w-32 h-32 rounded-full border-2 border-white/8 bg-[var(--card)] flex items-center justify-center text-zinc-600 text-sm">
            Photo
          </div>
        </motion.div>
      </div>
